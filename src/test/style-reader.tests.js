...
import * as styleReader from '../lib/style-reader'
...
const assertHtmlPath = (input, expected) => {
...
const assertDocumentMatcher = (input, expected) => {
...
const assertStyleMapping = (input, expected) => {
