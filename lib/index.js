...
var HeuristicsProcessor = require("./heuristics-processor").HeuristicsProcessor;
...
var standardOptions = exports.standardOptions = {
    styleMap: [
        ...
        style("p.CenteredHeading => h2.centered:fresh"),
...
Converter.prototype.convertToHtml = function(inputOptions) {
    ...
    return read(inputOptions)
        .then(function(documentResult) {
            return processHeuristics(documentResult);
        })
        .then(function(documentResult) {
...
function processHeuristics(documentResult) {
    var heuristicsProcessor = new HeuristicsProcessor();
    return heuristicsProcessor.processHeuristics(documentResult);
}
