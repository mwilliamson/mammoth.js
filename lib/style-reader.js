...
function documentMatcherRule() {
    ...
    var tableRule = identifierToConstant("t", documentMatchers.table);

    var elementTypeRule = lop.rules.firstOf("p or r or t",
            paragraphRule,
            runRule,
            tableRule
            );
    ...
    var paragraphOrRunOrTable = sequence(
