...
var readNumberingFromZipFile = function(docxFile) {
    return readNumberingStylesFromZipFile(docxFile)
        .then(function(numberingStyles){
            var numReader = new numberingXml.NumberingReader(numberingStyles);
            var xmlNumReader = xmlFileReader({
                filename: "word/numbering.xml",
                readElement: numReader.readNumbering,
                defaultValue: numberingXml.defaultNumbering
            });
            return xmlNumReader(docxFile);
        });
};
...
var readNumberingStylesFromZipFile = xmlFileReader({
    filename: "word/styles.xml",
    readElement: stylesReader.readNumberingStylesXml,
    defaultValue: stylesReader.defaultNumberingStyles
});
