...
ReadResult.prototype.toExtra = function() {
    // TODO: handle non-empty this.extra
    return new ReadResult(null, this.value, this.messages);
};

ReadResult.prototype.insertExtra = function() {
    var extra = this.extra;
    if (extra && extra.length) {
        return new ReadResult(_.flatten([this.value, extra]), null, this.messages);
    } else {
        return this;
    }
};
...
ReadResult.prototype.flatMap = function(func) {
    ...
    // TODO: handle non-empty this.extra
    return new ReadResult(result.value.element, result.value.extra, result.messages);
};
