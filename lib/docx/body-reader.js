    ...
    function readXmlElement(element) {
        if (element.type === "element") {
            ...
            if (handler) {
                ...
                if (options.xmlStyleMap) {
                    _.every(options.xmlStyleMap, function(test, styleName) {
                        var res = test(element);
                        if(res) {
                            result.value.styleId = styleName;
                            result.value.styleName = styleName;
                        }
                        return !res;
                    });
                } 
