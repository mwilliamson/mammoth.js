...
function BodyReader(options) {
        ...
        return readXmlElements(element.children)
            ...
            .flatMap(function(children) {
                return style.map(function(properties) {
                    properties.alignment= element.firstOrEmpty("w:jc").attributes["w:val"];
                    return documents.Table(children, properties, tableGrid);
                });
            });
    }
    ...
    function readTableProperties(element) {
        ...
        return {style:style, borders:borders};
    }
    ...
    function calculateBorders(rows, borders) {
        rows.forEach((row, rIdx)=>{
            row.children.forEach((cellCont, cIdx)=>{
                var cell = cellCont.borders;
                // if(cell.top==null) {
                //     cell.top = borders.top || 'none';
                // }
                // if(cell.bottom == null) {
                //     cell.bottom = borders.bottom || 'none';
                // }
                // if(cell.start == null) {
                //     cell.start = borders.start || 'none';
                // }
                // if(cell.end == null) {
                //     cell.end = borders.end || 'none';
                // }
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            var cell = documents.TableCell(children, {colSpan: colSpan}, borders);
