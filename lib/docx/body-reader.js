    ...
    var xmlElementReaders = {
        ...
        "w:r": function(element) {
            return readXmlElements(element.children)
                .map(function(children) {
                    ...
                    var scopedHyperlink = scopedComplexFieldOfType(complexFieldStack, "hyperlink");
        ...
        "w:fldChar": function(element) {
            ...
            if (type === "begin") {
                ...
                if (href !== null) {
                    complexFieldStack.push({type: "hyperlink", href: href});
                } else {
                    complexFieldStack.push({type: "unknown"});
                }
            }
            return emptyResult();
        },
