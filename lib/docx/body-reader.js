...
function BodyReader(options) {
    ...
    function readTableRow(element) {
        ...
        var isHeader = !!(properties.first("w:tblHeader") || properties.children && properties.children[0].attributes['w:firstRow'] === '1');
        return readXmlElements(element.children).map(function(children) {
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            var isTableHeader = properties.children && properties.children[0].attributes['w:firstColumn'] === '1';
            
            var cell = documents.TableCell(children, {colSpan: colSpan});
            cell.isTableHeader = isTableHeader;
