...
function BodyReader(options) {
    ...
    function readRunProperties(element) {
        ...
        readRunStyle(properties, element, messages);
        ...
        return elementResultWithMessages(properties, messages);
    }
    
    function readRunStyle(properties, element, messages) {
        ...
        if (styleElement) {
            ...
            if (styleId) {
                ...
                if (style) {
                    ...
                    messages.push(undefinedStyleWarning("Run", styleId));
                }
            }
        }
    }
            ...
            if (styleElement) {
                ...
                if (styleId) {
                    ...
                    if (style) {
                        ...
                        messages.push(undefinedStyleWarning("Paragraph", styleId));
                    }
                }
            }
