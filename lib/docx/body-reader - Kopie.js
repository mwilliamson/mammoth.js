...
>>>>>>> refs/remotes/mwilliamson/master
...
>>>>>>> refs/remotes/mwilliamson/master
    function readTable(element) {
        return readXmlElements(element.children)
                ...
                .map(function(children) {
                    var properties = _.find(children, isTableProperties);
                    return new documents.Table(
                            children.filter(negate(isTableProperties)),
                            properties);
                });
    }
...
function isTableProperties(element) {
    return element.type === "tableProperties";
}
