...
Matcher.prototype.matches = function(element) {
    return element.type === this._elementType &&
        (!this._styleName || element.styleName === this._styleName) &&
        (!this._listIndex || isList(element, this._listIndex, this._listIsOrdered));
}

Matcher.prototype.orderedList = function(levelIndex) {
    this._listIndex = levelIndex;
    this._listIsOrdered = true;
    return this;
}

Matcher.prototype.unorderedList = function(levelIndex) {
    this._listIndex = levelIndex;
    this._listIsOrdered = false;
    return this;
}
