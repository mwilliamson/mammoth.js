...
function DocumentConversion(options) {
    ...
    function convertToHtml(document) {
        var messages = [];
        var html = new HtmlGenerator({prettyPrint: options.prettyPrint, markdown: options.markdown});
    ...
    function convertRun(run, html, messages, callback) {
        var runHtml = new HtmlGenerator({ markdown: options.markdown });
        if (run.styleId) {
    ...
    function convertTableCell(element, html, messages, callback) {
        ...
        async.map(element.children, function(child, callback) {
            var cellHtml = new HtmlGenerator({ markdown: options.markdown });
    ...
    var elementConverters = {
        ...
        "note": function(element, html, messages, callback) {
            ...
            var footnoteHtml = new HtmlGenerator({ markdown: options.markdown });
