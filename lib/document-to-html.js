...
function DocumentConversion(options, comments) {
    ...
    function convertTable(element, messages, options) {
        ...
        if (element.tableGrid) {
            el.attributes  = {"data-table-grid": JSON.stringify(element.tableGrid)};
        }
        return el;
    }
    ...
    function getBorderStyle(borders) {
        return `border-width: 3px; border-style: ${borders.top} ${borders.end} ${borders.bottom} ${borders.start}`;
