...
function DocumentConversion(options, comments) {
    ...
    function htmlPathForParagraph(element, messages) {
        ...
        if (style) {
            ...
            if ( element.styleId && (element.styleId.startsWith('Product') ) ) {
                return htmlPaths.topLevelElement("h2");
            }

            if ( element.styleId && (element.styleId.startsWith('IssueTitle') ) ) {
                return htmlPaths.topLevelElement("h3");
            }
