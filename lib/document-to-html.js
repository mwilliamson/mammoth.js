...
function DocumentConversion(options, comments) {
    ...
    options = _.extend({ignoreEmptyTables: true}, options);
    var idPrefix = options.idPrefix === undefined ? "" : options.idPrefix;

    var defaultParagraphStyle = htmlPaths.topLevelElement("p");
    var defaultTableStyle = htmlPaths.topLevelElement("table");
    ...
    function convertTable(element, messages) {
        return htmlPathForTable(element, messages).wrap(function () {
            var children = convertElements(element.children, messages);
            if (options.ignoreEmptyTable) {
                return children;
            } else {
    ...
    function htmlPathForTable(element, messages) {
        var style = findStyle(element);
        ...
        if (style) {
            ...
            if (element.styleId) {
                messages.push(unrecognisedStyleWarning("table", element));
            }
